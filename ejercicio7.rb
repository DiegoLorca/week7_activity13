...
# puts case opcion
# when '1' then add_element(inventario)
# when '2' then delete_element(inventario)
# when '3' then update_element(inventario)
# when '4' then stock_summary(inventario)
# when '5' then max_stock(inventario)
# when '6' then check_if_exists(inventario)
# when '7' then exit
# end
# end
